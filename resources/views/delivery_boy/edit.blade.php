...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-lg-offset-2">
            <form class="form form-horizontal mar-top" action="{{ route('deliveryboy.update', $delivery_boy->id) }}" method="POST"
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                <input type="text" class="form-control" value="{{ old('first_name', $delivery_boy->first_name) }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                <input type="text" class="form-control" value="{{ old('last_name',$delivery_boy->last_name) }}" name="last_name"
                                    required>
                                @error('last_name')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                <input type="text" class="form-control" value="{{ old('dob',$delivery_boy->dob) }}" name="dob">
                                @error('dob')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                <input type="email" class="form-control" value="{{ old('email',$delivery_boy->email) }}" name="email"
                                    required>
                                @error('email')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                <select class="form-control demo-select2-placeholder" name="active_status"
                                    id="active_status">
                                    <option value="1" {{ old('active_status',$delivery_boy->active_status) == "1" ? 'selected' : '' }}>Active</option>
                                    <option value="0" {{ old('active_status',$delivery_boy->active_status) == "0" ? 'selected' : '' }}>Inactive</option>
                                </select>
                                @error('active_status')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                <select class="form-control demo-select2-placeholder" name="availability_status"
                                    ...
                                    <option value="1" {{ old('availability_status', $delivery_boy->availability_status) == "1" ? 'selected' : '' }}>Active
                                    </option>
                                    <option value="0" {{ old('availability_status', $delivery_boy->availability_status) == "0" ? 'selected' : '' }}>InActive
                                    </option>
                                </select>
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                <input type="text" class="form-control" name="address" value="{{ old('address',$delivery_boy->address) }}"
                                    required>
                                @error('address')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                <input type="text" class="form-control" name="city" value="{{ old('city',$delivery_boy->city) }}">
                                @error('city')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                <input type="text" class="form-control" name="zip_code" value="{{ old('zip_code',$delivery_boy->zip_code) }}"
                                    required>
                                @error('zip_code')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
